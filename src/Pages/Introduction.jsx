...
const Introduction = () => {
  ...
  return (
    <Container className='container' >
        <Row>
        <Col>
        <h1 className='heading'><u>Nilganga Hydropower Company Pvt. Ltd.</u></h1>
      <p className='paragraph'>Nilganga Hydropower Pvt Ltd is a private company involved in the development, operation, 
...
<li>Nilganga Hydropower Pvt Ltd also responsible for managing its day-to-day operations, including maintenance of equipment and ensuring consistent power generation.</li></ol></p>

  <Table bordered striped hover className='table' style={{border:"4px solid"}}>
    <thead>
      <tr>
        <th className='intro_heading'> Company </th>
        <th className="intro_heading"> Nilganga Hydropower Co. Pvt. Ltd. </th>
      </tr>
    </thead>
